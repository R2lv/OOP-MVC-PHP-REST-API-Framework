...
class Router {
    ...
    const CMD_PROCESSED = 200;
    const CMD_UNKNOWN = 400;
    const CMD_INVALID = 405;
    const CMD_MALFORMED = 409;
    const USR_UNAUTHORIZED = 401;
    const USR_BILLING = 402;
    const SRC_NOTFOUND = 404;
    const INTERNAL_ERROR = 500;
    const CMD_UNPROCESSABLE = 422;
    ...
    public function serve($Request) {
        ...
        $model_name = $model_namespace . $end_point;
        $controller_name = $controller_namespace . $end_point;
